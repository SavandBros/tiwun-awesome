 ...
 * @returns [Factory]
 * @namespace tiwunAwesome.account.services.AuthenticationService
 */
function AuthenticationService($rootScope, $http, $log, $window, ENV) {
     ...
     * @memberOf tiwunAwesome.account.services.AuthenticationService
     */
    ...
    function logout() {
        return $http.post(ENV.apiEndpoint + 'users/logout/').then(
            function(data, status, headers, config) {
                unAuthenticate();
                $rootScope.$broadcast('tiwunAwesome.account.service.AuthenticationService:SignedOut');
            },
            function(data, status, headers, config) {
    ...
    function register(email, password) {
        return $http.post(ENV.apiEndpoint + 'users/', {
            ...
            function(data, status, headers, config) {
                $rootScope.$broadcast('tiwunAwesome.account.service.AuthenticationService:Registered');
