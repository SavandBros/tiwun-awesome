...
(function() {
    ...
    angular.module('tiwunAwesome.item.controllers.ItemsController', [])
    ...
    function ItemsController($scope) {
         ...
         * @memberOf tiwunAwesome.item.controllers.ItemsControllers
         **/
         ...
         * @memberOf tiwunAwesome.items.controllers.ItemControllers
         */
         ...
         * @memberOf tiwunAwesome.items.controllers.ItemsControllers
         */
